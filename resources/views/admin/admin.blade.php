                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{URL::asset('/admin/work/done')}}"><i class="fa fa-star"></i> What have I done<i class="fa fa-question-circle" style="padding-left: 0.5em"></i></a>
                                </li>
                                <li>
                                    <a href="{{URL::asset('/admin/work/doing')}}"><i class="fa fa-star-half-o"></i> What I'm doing<i class="fa fa-question-circle" style="padding-left: 0.5em"></i></a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
