		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="{{ URL::asset('/admin/blog/storearticle') }}" method="POST">
					...
					<!-- <textarea name="content" rows="10" class="form-control" required="required" placeholder="Content...">
					{{--Request::old('content')--}}
					</textarea> -->
				<br>
	...
	$(function() {
		var config = {
			...
			toolbarIcons : function() {
				return ["undo", "redo", "|", "preview", "watch", "fullscreen", "goto-line", "search", "|", "code","code-block", "preformatted-text", "|", "datetime", "table", "image", "reference-link", "link", "emoji", "html-entities", "pagebreak", "|", "help"];
			},
			onload : function() {
				this.addKeyMap({
					"Ctrl-S": function() {
